...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    // All the lables and Mapview connecets
    @IBOutlet weak var cSpeedLabel: UILabel!
    @IBOutlet weak var mSpeedLabel: UILabel!
    @IBOutlet weak var aSpeedLabel: UILabel!
    @IBOutlet weak var distanceLabel: UILabel!
    @IBOutlet weak var myMap: MKMapView! //map view
    @IBOutlet weak var redView: UIView! // red lable when press start
    @IBOutlet weak var greenView: UIView! // green view when press start
    @IBOutlet weak var maxAcceleration: UILabel!
    
    
    // given values to variables
    ...
    // function works whene start button press
    ...
    // function works when stop button press
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        // IF current speed higher than max speed
        ...
        // showing meter from distance to cover
    ...
    //Calculate time to how much take time ti reach distance
